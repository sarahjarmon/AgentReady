...
function render(result) {
  ...
  viewPlan.textContent = state.confirmed ? "View My Full Fix Plan →" : "Verifying your subscription…";
  if (state.confirmed) localStorage.setItem("agentready.paid-verified.v1", "1");
